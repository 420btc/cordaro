...
const es = {
  ...
  'sch.title': 'Resonancia Schumann',
  'sch.subtitle': 'Espectrograma real · estación de Tomsk (Siberia) · se actualiza cada 5 min',
  'sch.refresh': 'Actualizar',
  'sch.chart.shm': 'Espectrograma',
  'sch.chart.sra': 'Amplitud',
  'sch.chart.srf': 'Frecuencia',
  'sch.chart.srq': 'Factor Q',
  'sch.alt': 'Espectrograma de resonancia Schumann (Tomsk)',
  'sch.error': 'Imagen no disponible ahora mismo. Prueba a actualizar en unos minutos.',
  'sch.hint': 'Eje Y: frecuencia (Hz) · eje X: tiempo (UTC) · brillo = potencia',
  'sch.source': 'Datos: Space Observing System · Tomsk',
  'sch.sourceLink': 'sos70.ru',
  'sch.loading': 'Cargando espectrograma…',
  'sch.updated': 'Actualizado',
  'sch.rel.sec': 'hace {n} s',
  'sch.rel.min': 'hace {n} min',
  'sch.rel.hour': 'hace {n} h',

  'fl.title': 'Flares solares · GOES',
  'fl.subtitle': 'Flujo de rayos X · banda 0.1–0.8 nm',
  'fl.loading': 'Cargando flujo de rayos X…',
  'fl.error': 'Sin datos de flares solares',
  'fl.refresh': 'Actualizar',
  'fl.flux': 'Flujo de rayos X',
  'fl.axisTime': 'Tiempo (UTC)',
  'fl.axisFlux': 'W/m²',

  'ssgi.title': 'Geometría planetaria · SSGI',
  'ssgi.subtitle': 'Índice de geometría del Sistema Solar · armónicos EM de 45° y 90° · ventana 7 días',
  'ssgi.loading': 'Calculando geometría planetaria…',
  'ssgi.legend.sum': 'Índice SUM',
  'ssgi.legend.mercury': 'Mercurio',
  'ssgi.legend.venus': 'Venus',
  'ssgi.legend.earth': 'Tierra',
  'ssgi.legend.moon': 'Luna',
  'ssgi.legend.conjunction': 'Conjunción (0°/180°)',
  'ssgi.legend.square': 'Ángulo recto (90°)',
  'ssgi.legend.semi': 'Semi-ángulo (45°/135°)',
  'ssgi.legend.quake': 'Sismo (M)',
  'ssgi.hint': 'Picos de geometría crítica por cuerpo · convergencia temporal ≈ racimos sísmicos',
  'ssgi.source': 'Modelo: SSGEOS · SSGI',

  'heat.title': 'Mapa de calor de cruces',
  'heat.subtitle': 'Densidad mensual de cruces Luna/antípoda · pasados y futuros',
  'heat.prev': 'Mes anterior',
  'heat.next': 'Mes siguiente',
  'heat.crossings': 'cruces',
  'heat.moon': 'Luna',
  'heat.antipode': 'Antípoda',
  'heat.loading': 'Calculando cruces del mes…',
  'heat.legend': 'Leyenda',
  'heat.hint': 'El brillo se acumula donde se repiten cruces',

  'ign.title': 'Sismicidad regional',
  'ign.subtitle': 'Datos locales por región · detecta tu ubicación',
  'ign.loading': 'Cargando sismos…',
  'ign.error': 'No se pudieron cargar los datos sísmicos',
  'ign.locationOn': 'Ubicación activada',
  'ign.useLocation': 'Usar mi ubicación',
  'ign.select': 'Elige una región',
  'ign.noRegion': 'Selecciona una región o activa tu ubicación para ver los sismos',
  'ign.recent': 'Recientes',
  'ign.nearby': 'Cerca de ti',
  'ign.count': '{n} sismos',
  'ign.depth': 'prof. {n} km',
  'ign.distance': '{n} km',
  'ign.empty': 'Sin sismos recientes',
  'ign.you': 'Tú',
  'ign.source': 'Datos: IGN · USGS · BMKG',

  'region.espana': 'España',
  'region.eeuu': 'EE. UU.',
  ...
  'chat.useLocation': 'Usar mi ubicación',
  'chat.locating': 'Obteniendo ubicación…',
  'chat.regionNeed': 'Activa tu ubicación para unirte al chat de tu región',
  'chat.regionHint': 'Chat de región · hexágono H3',
  'chat.empty': 'Aún no hay mensajes',
  'chat.error': 'No se pudo conectar con el chat',
  ...
  'auth.favorites': 'Cruces favoritos',
  'auth.noFavorites': 'Aún no has marcado cruces favoritos',
  'auth.remove': 'Quitar',
  'auth.logout': 'Cerrar sesión',
  'auth.favorite': 'Añadir a favoritos',
  'auth.passwordMismatch': 'Las contraseñas no coinciden',
  'auth.createAccountTitle': '¿Crear una cuenta?',
  'auth.createAccountDesc': 'Guarda tu nombre y tus cruces favoritos con contraseña',
  'auth.later': 'Ahora no',
  ...
  'kpi.quakesSub': 'máx M',
  'kpi.latitude': 'Latitud sublunar',
  'kpi.latitudeSub': 'rango del día',
  ...
  'crossings.riskTitle': 'Próximas ventanas de riesgo',
  ...
  'crossing.notValidated': 'Sin sismo a 100 km en ±1 h',
  'crossing.window': 'Ventana 1h',
  'crossing.windowInfo': 'Richard Cordaro: ventana de probabilidad de 1 hora. El sismo puede producirse hasta 1 h después del cruce.',
  'crossing.info': 'Verificado con sismos USGS ≥ M4 · radio 100 km · ventana ±1 h',
...
const en: Record<keyof typeof es, string> = {
  ...
  'sch.title': 'Schumann resonance',
  'sch.subtitle': 'Live spectrogram · Tomsk station (Siberia) · updated every 5 min',
  'sch.refresh': 'Refresh',
  'sch.chart.shm': 'Spectrogram',
  'sch.chart.sra': 'Amplitude',
  'sch.chart.srf': 'Frequency',
  'sch.chart.srq': 'Q-factor',
  'sch.alt': 'Schumann resonance spectrogram (Tomsk)',
  'sch.error': 'Image not available right now. Try again in a few minutes.',
  'sch.hint': 'Y-axis: frequency (Hz) · X-axis: time (UTC) · brightness = power',
  'sch.source': 'Data: Space Observing System · Tomsk',
  'sch.sourceLink': 'sos70.ru',
  'sch.loading': 'Loading spectrogram…',
  'sch.updated': 'Updated',
  'sch.rel.sec': '{n} s ago',
  'sch.rel.min': '{n} min ago',
  'sch.rel.hour': '{n} h ago',

  'fl.title': 'Solar flares · GOES',
  'fl.subtitle': 'X-ray flux · 0.1–0.8 nm band',
  'fl.loading': 'Loading X-ray flux…',
  'fl.error': 'No solar flare data',
  'fl.refresh': 'Refresh',
  'fl.flux': 'X-ray flux',
  'fl.axisTime': 'Time (UTC)',
  'fl.axisFlux': 'W/m²',

  'ssgi.title': 'Planetary geometry · SSGI',
  'ssgi.subtitle': 'Solar System Geometry Index · 45° & 90° EM harmonics · 7-day window',
  'ssgi.loading': 'Computing planetary geometry…',
  'ssgi.legend.sum': 'SUM index',
  'ssgi.legend.mercury': 'Mercury',
  'ssgi.legend.venus': 'Venus',
  'ssgi.legend.earth': 'Earth',
  'ssgi.legend.moon': 'Moon',
  'ssgi.legend.conjunction': 'Conjunction (0°/180°)',
  'ssgi.legend.square': 'Right angle (90°)',
  'ssgi.legend.semi': 'Semi-angle (45°/135°)',
  'ssgi.legend.quake': 'Quake (M)',
  'ssgi.hint': 'Critical geometry peaks by body · temporal convergence ≈ seismic clusters',
  'ssgi.source': 'Model: SSGEOS · SSGI',

  'heat.title': 'Crossings heatmap',
  'heat.subtitle': 'Monthly Moon/antipode crossing density · past and future',
  'heat.prev': 'Previous month',
  'heat.next': 'Next month',
  'heat.crossings': 'crossings',
  'heat.moon': 'Moon',
  'heat.antipode': 'Antipode',
  'heat.loading': 'Computing monthly crossings…',
  'heat.legend': 'Legend',
  'heat.hint': 'Brightness builds up where crossings repeat',

  'ign.title': 'Regional seismicity',
  'ign.subtitle': 'Local data by region · detect your location',
  'ign.loading': 'Loading quakes…',
  'ign.error': 'Could not load seismic data',
  'ign.locationOn': 'Location on',
  'ign.useLocation': 'Use my location',
  'ign.select': 'Choose a region',
  'ign.noRegion': 'Select a region or enable your location to see quakes',
  'ign.recent': 'Recent',
  'ign.nearby': 'Near you',
  'ign.count': '{n} quakes',
  'ign.depth': 'depth {n} km',
  'ign.distance': '{n} km',
  'ign.empty': 'No recent quakes',
  'ign.you': 'You',
  'ign.source': 'Data: IGN · USGS · BMKG',
  ...
  'chat.useLocation': 'Use my location',
  'chat.locating': 'Getting location…',
  'chat.regionNeed': 'Enable your location to join your region chat',
  'chat.regionHint': 'Region chat · H3 hexagon',
  ...
  'auth.favorites': 'Favorite crossings',
  'auth.noFavorites': 'No favorite crossings yet',
  'auth.remove': 'Remove',
  'auth.logout': 'Log out',
  'auth.favorite': 'Add to favorites',
  'auth.passwordMismatch': 'Passwords do not match',
  'auth.createAccountTitle': 'Create an account?',
  'auth.createAccountDesc': 'Save your name and favorite crossings with a password',
  'auth.later': 'Later',
  ...
  'kpi.quakesSub': 'max M',
  'kpi.latitude': 'Sub-lunar latitude',
  'kpi.latitudeSub': 'daily range',
  ...
  'crossings.riskTitle': 'Upcoming risk windows',
  ...
  'crossing.notValidated': 'No quake within 100 km in ±1h',
  'crossing.window': '1h window',
  'crossing.windowInfo': 'Richard Cordaro: 1-hour probability window. The quake can occur up to 1h after the crossing.',
  'crossing.info': 'Checked with USGS quakes ≥ M4 · 100 km radius · ±1h window',
