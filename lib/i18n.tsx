...
const es = {
  ...
  'ign.title': 'Sismicidad España · IGN',
  'ign.subtitle': 'Últimos 10 días · Red Sísmica Nacional',
  'ign.loading': 'Cargando sismos…',
  'ign.error': 'No se pudieron cargar los datos del IGN',
  ...
  'ign.you': 'Tú',
  'ign.source': 'Datos: IGN · Red Sísmica Nacional',
...
const en: Record<keyof typeof es, string> = {
  ...
  'ign.title': 'Spain seismicity · IGN',
  'ign.subtitle': 'Last 10 days · National Seismic Network',
  'ign.loading': 'Loading quakes…',
  'ign.error': 'Could not load IGN data',
  ...
  'ign.you': 'You',
  'ign.source': 'Data: IGN · National Seismic Network',
