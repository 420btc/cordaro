...
export const MiniMap = memo(function MiniMap({ latitude, longitude, color }: Props) {
  return (
    <MapContainer center={[latitude, longitude]} zoom={2} minZoom={1} maxZoom={9} scrollWheelZoom dragging zoomControl attributionControl={false} className="h-full w-full" style={{ background: '#0e1116' }}>
      <AutoResize />
